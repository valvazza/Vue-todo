...
<template>
    <li>
        ...
        <div class="todo-actions">
            <Icon v-if="todo.isEditing" icon="ph:check-circle-bold" class="icon" color="#41b090" width="22" @click="$emit('edit-todo',index)"/>

            <Icon v-else icon="ph:pencil-fill" class="icon" color="#41b090" width="22" @click="$emit('edit-todo',index)" />
